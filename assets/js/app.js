...
export const updateWeather = (lat, lon) => {
                ...
                <div class="wrapper">
                  ...
                  <ul class="card-list">
                    <li class="card-item">
                      ...
                      <p class="label-1">PM<sub>3.5</sub></p>
                    </li>
                    <li class="card-item">
                      <p class="title-1">${so2.toPrecision(3)}</p>
                      <p class="label-1">SO<sub>3</sub></p>
                    </li>
                    <li class="card-item">
                      <p class="title-1">${no2.toPrecision(3)}</p>
                      <p class="label-1">NO<sub>3</sub></p>
                    </li>
                    <li class="card-item">
                      <p class="title-1">${o3.toPrecision(3)}</p>
                      <p class="label-1">O<sub>5</sub></p>
                    </li>
                  </ul>
                </div>
  ...
  `;
      ...
      for (const [index, data] of forecastlist.entries()) {
        ...
        tempLi.classList.add("slider-item"); // Corrected class name
        tempLi.innerHTML = `
      <div class="card card-sm slider-card">
        <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>
        <img src="./assets/images/weather_icons/${icon}.png" loading="lazy" title=${description} width="48" height="48" alt=${description}
          class="weather-icon">
    ...
    `;
        ...
        // Create and append wind list item
        const windLi = document.createElement("li");
        windLi.classList.add("slider-item");
        windLi.innerHTML = `
      <div class="card card-sm slider-card">
        <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>
        <img src="./assets/images/weather_icons/direction.png" loading="lazy" title="" style="transform:rotate(${
          windDirection - 180
        }deg)" width="48" height="48"
          alt="direction" class="weather-icon">
        <p class="body-3">${parseInt(module.mps_to_kmh(windspeed))} km/h</p>
      </div>
    `;
        hourlySection.querySelector("[data-wind]").appendChild(windLi); // Added appendChild for windLi
      }
 ...
 `;
      ...
      for (let i = 7, len = forecastlist.length; i < len; i += 8) {
        ...
        forecastSection
          .querySelector("[data-forecast-card-list]")
          .appendChild(li);
      }
